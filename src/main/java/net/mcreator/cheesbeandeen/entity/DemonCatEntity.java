...
package net.mcreator.cheesbeandeen.entity;
...
import net.mcreator.cheesbeandeen.entity.renderer.DemonCatRenderer;
import net.mcreator.cheesbeandeen.CheesbeandeenModElements;

import java.util.Random;

@CheesbeandeenModElements.ModElement.Tag
public class DemonCatEntity extends CheesbeandeenModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1.4f, 0.9f)).build("demon_cat").setRegistryName("demon_cat");
	public DemonCatEntity(CheesbeandeenModElements instance) {
		super(instance, 2);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DemonCatRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -65485, -1, new Item.Properties().group(CBiomeItemGroup.tab)).setRegistryName("demon_cat_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("cheesbeandeen:camp").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(ForgeMod.SWIM_SPEED.get(), 5);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			setCustomName(new StringTextComponent("Demon thing"));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(EncasedOrbItem.block));
		}
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.soul_soil.fall"));
		}
		...
		public void livingTick() {
			...
			if (true)
				for (int l = 0; l < 2; ++l) {
					...
					double d3 = (random.nextFloat() - 0.5D) * 1.4000000014901162D;
					double d4 = (random.nextFloat() - 0.5D) * 1.4000000014901162D;
					double d5 = (random.nextFloat() - 0.5D) * 1.4000000014901162D;
