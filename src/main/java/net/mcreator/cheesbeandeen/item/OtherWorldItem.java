...
import net.mcreator.cheesbeandeen.world.dimension.OtherWorldDimension;
import net.mcreator.cheesbeandeen.itemgroup.CBiomeItemGroup;

public class OtherWorldItem extends Item {
	@ObjectHolder("cheesbeandeen:other_world")
	public static final Item block = null;
	public OtherWorldItem() {
		super(new Item.Properties().group(CBiomeItemGroup.tab).maxDamage(64));
	}
