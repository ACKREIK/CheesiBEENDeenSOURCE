...
public class ZoneofthedeadBiome extends CheesbeandeenModElements.ModElement {
	public static Biome biome;
	public ZoneofthedeadBiome(CheesbeandeenModElements instance) {
		super(instance, 9);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("cheesbeandeen:zoneofthedead"));
			}
		}
	}
	@Override
