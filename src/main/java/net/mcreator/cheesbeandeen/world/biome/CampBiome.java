...
public class CampBiome extends CheesbeandeenModElements.ModElement {
	public static Biome biome;
	public CampBiome(CheesbeandeenModElements instance) {
		super(instance, 5);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-13421773).setWaterColor(-16764109).setWaterFogColor(-16777216)
						.withSkyColor(-13421773).withFoliageColor(-6711040).withGrassColor(-13434880)
						...
						.setMoodSound(new MoodSoundAmbience((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("ambient.crimson_forest.mood")), 6000, 8, 2))
						...
						.setMusic(new BackgroundMusicSelector(
								...
								12000, 24000, true))
						.setParticle(new ParticleEffectAmbience(ParticleTypes.LARGE_SMOKE, 0.016f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(CompactedCorpsesBlock.block.getDefaultState(),
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.WARPED_HYPHAE.getDefaultState()),
								new SimpleBlockStateProvider(Blocks.STRIPPED_WARPED_STEM.getDefaultState()),
								new MegaPineFoliagePlacer(FeatureSpread.func_242252_a(0), FeatureSpread.func_242252_a(0),
										FeatureSpread.func_242253_a(13, 4)),
								new GiantTrunkPlacer(11, 2, 14), new TwoLayerFeature(1, 1, 2)))
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.NONE).category(Biome.Category.NONE).depth(2.8f).scale(2f).temperature(2f)
						.downfall(0f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("cheesbeandeen:camp"));
			}
		}
	}
	@Override
					...
					for (Direction direction : Direction.Plane.HORIZONTAL) {
						if (p_225576_2_.nextFloat() <= 0.25F) {
							...
							if (Feature.isAirAt(p_225576_1_, blockpos)) {
								BlockState blockstate = Blocks.PURPUR_BLOCK.getDefaultState();
